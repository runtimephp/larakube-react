...
final class ShowClusterInfrastructureControllerTest extends TestCase
{
    use RefreshDatabase;

    public function test_it_can_show_cluster_infrastructure(): void
    {
        ...
        $response = $this
            ->actingAs($user)
            ->get(route('clusters.infrastructure', [
        ...
        $response->assertInertia(fn ($page) => $page
            ->component('clusters/show/infrastructure')
            ->has('cluster')
        );
    }

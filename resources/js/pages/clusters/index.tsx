...
import { useOrganizationRoute } from '@/hooks/use-organization-route';
            ...
            <div className="mx-auto w-full max-w-7xl space-y-12 px-4 py-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    {clusters.map((cluster) => (
                        <Link key={cluster.id} href={route('clusters.show', { cluster: cluster.slug })} className="block">
                            <Card className="transition-colors hover:bg-secondary/10">
                                <CardHeader>
                                    <CardTitle>
                                        <div className="flex items-center justify-between">

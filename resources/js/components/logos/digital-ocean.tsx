export default function DigitalOceanLogo({ className = '', fill = '#0080ff' }: { className?: string; fill?: string }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="65.2 173.5 32 32" fill={fill} className={className}>
